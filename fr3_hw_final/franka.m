...
% --- Configuration ---
csv_filename = 'franka_extensive_obstacle.csv';
...
obstacle6_min_pos = [0.15, -0.6, 0.4];
obstacle6_size = [0.1, 0.3, 0.3];
obstacle7_min_pos = [-0.25, -0.6, 0.4];
obstacle7_size = [0.1, 0.3, 0.3];
obstacle8_min_pos = [-0.05, -0.6, 0.2];
obstacle8_size = [0.1, 0.3, 0.3];
obstacle9_min_pos = [0.15, 0.3, 0.4];
obstacle9_size = [0.1, 0.3, 0.3];
obstacle10_min_pos = [-0.25, 0.3, 0.4];
obstacle10_size = [0.1, 0.3, 0.3];
...
x_current = [0.5, 0.0, 0.5];
% --- Simulation Setup ---
max_steps = 150; % Increased steps since tau is smaller
