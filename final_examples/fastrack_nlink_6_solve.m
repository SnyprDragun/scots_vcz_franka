% fastrack_nlink_6_solve.m (N_LINKS=6, finer grid [21,21] for proper convergence)
...
I_eff    = [1.0, 0.6, 0.4, 0.3, 0.15, 0.1, 0.06];
...
% Grid: finer [21,21] for proper HJ solver convergence
g_min = [-pi/2; -2];
g_max = [pi/2; 2];
N_grid = [21; 21];
